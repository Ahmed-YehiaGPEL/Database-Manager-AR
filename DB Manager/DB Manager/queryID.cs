...
{
    public partial class queryID : Form
    {
        public queryID()
        {
            InitializeComponent();
        ...
        {
            queryString = "SELECT * from pltg WHERE \"رقم بطاقة العضوية\" ==\"" + maskedTextBox1.Text + "\"";
        ...
        private void queryID_Load(object sender, EventArgs e)
        {
